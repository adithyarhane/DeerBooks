...
const BooksForEveryone = () => {
  const { booksForEveryone, isLoading } = useBookContext();
      ...
      <div className="max-w-400 mx-auto px-6">
        ...
        <div className="w-full">
          <div
            ref={scrollRef}
            className={`
              grid grid-flow-col no-scrollbar snap-x snap-mandatory overflow-x-auto pb-6 pt-4 gap-5
              auto-cols-[calc(80%)] 
          ...
          >
            {isLoading
              ...
              : booksForEveryone?.slice(0, 10).map((book) => (
...
export default BooksForEveryone;
